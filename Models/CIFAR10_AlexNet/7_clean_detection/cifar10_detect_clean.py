...
def Sparsity_Attack_Detection (model, device, offline_sparsity_maps, offline_sparsity_ranges, test_dataset, num_classes, args):
    ...
    print(f"Correctly predicted adversarials for each class (map): {wrongly_predicted_adversarial_for_class_map}\n")
    print(f"Correctly predicted adversarials for each class (rng): {wrongly_predicted_adversarial_for_class_range}\n")
    print(f"Number of generated adversarials for each class: {generated_clean_for_class}\n")
    ...
    print(f"Overall attack detection accuracy using sparsity-map method: {overall_error_map*100:.2f}\n")
    print(f"Overall attack detection accuracy using sparsity-range method: {overall_error_range*100:.2f}\n")
...
# for constrained:
# python3 cifar10_detect_clean.py   --dataset ../cifar10_dataset    --profile_sparsity_range ../5_profile/profile_data/sparsity_ranges.pth --profile_sparsity_map ../5_profile/profile_data/sparsity_maps.pt --sim_threshold 0.5

# for unconstrained:
# python3 cifar10_detect_clean.py  --dataset ../cifar10_dataset   --profile_sparsity_range ../5_profile/profile_data/sparsity_ranges.pth --profile_sparsity_map ../5_profile/profile_data/sparsity_maps.pt --sim_threshold 0.3