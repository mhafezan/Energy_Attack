...
if __name__ == "__main__":
    ...
    parser.add_argument('--lr', default=0.001, type=float, metavar='LR', help='Learning rate')
...
# python3 train_test_model3.py --phase train --epochs 100 --lr 0.001 --batch-size 128 --optimizer adam
