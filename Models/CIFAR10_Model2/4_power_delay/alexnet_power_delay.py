...
# python3 alexnet_power_delay.py --power --arch cnvlutin --batch_size 1 --adversarial --adv_images adversarial_data/adversarial_dataset_by_substitute_model2.pt --weights weights/alexnet_cifar10_fc_one_out.pkl

# For test on original CIFAR10
# python3 alexnet_power_delay.py --power --arch cnvlutin --batch_size 1 --dataset ../cifar10_dataset --weights weights/alexnet_cifar10_fc_one_out.pkl