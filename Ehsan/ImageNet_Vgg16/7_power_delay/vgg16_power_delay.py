...
class VGG16(nn.Module):
    ...
    def forward(self, x, SR=True, PC=False):
        ...
        L1_cycles_detail, L2_cycles_detail, L3_cycles_detail, L4_cycles_detail, L5_cycles_detail, L6_cycles_detail, L7_cycles_detail, L8_cycles_detail, L9_cycles_detail, L10_cycles_detail, L11_cycles_detail, L12_cycles_detail, L13_cycles_detail, L14_cycles_detail, L15_cycles_detail = ([] for _ in range(15))
        L1_dnmc_detail, L2_dnmc_detail, L3_dnmc_detail, L4_dnmc_detail, L5_dnmc_detail, L6_dnmc_detail, L7_dnmc_detail, L8_dnmc_detail, L9_dnmc_detail, L10_dnmc_detail, L11_dnmc_detail, L12_dnmc_detail, L13_dnmc_detail, L14_dnmc_detail, L15_dnmc_detail = ([] for _ in range(15))
        ...
        cycles_detail_inference = [a + b + c + d + e + f + g + h + i + j + k + l + m + n + o for a, b, c, d, e, f, g, h, i, j, k, l, m, n, o in zip(
                                    L1_cycles_detail, L2_cycles_detail, L3_cycles_detail, L4_cycles_detail, L5_cycles_detail, L6_cycles_detail,
                                    L7_cycles_detail, L8_cycles_detail, L9_cycles_detail, L10_cycles_detail, L11_cycles_detail, L12_cycles_detail,
                                    L13_cycles_detail, L14_cycles_detail, L15_cycles_detail)]
        
        eng_dnmc_detail_inference = [a + b + c + d + e + f + g + h + i + j + k + l + m + n + o for a, b, c, d, e, f, g, h, i, j, k, l, m, n, o in zip(
                                    L1_dnmc_detail, L2_dnmc_detail, L3_dnmc_detail, L4_dnmc_detail, L5_dnmc_detail, L6_dnmc_detail, L7_dnmc_detail,
                                    L8_dnmc_detail, L9_dnmc_detail, L10_dnmc_detail, L11_dnmc_detail, L12_dnmc_detail, L13_dnmc_detail, L14_dnmc_detail,
                                    L15_dnmc_detail)]
...
if __name__ == '__main__':
    ...
    model = VGG16(args=args).to(device)
    ...
    for index, (image, label) in enumerate(tqdm(test_loader, desc='Data Progress')):
        ...
        """or net_sizes += (9111040*args.batch_size)"""
...
# python3 vgg16_power_delay.py --power --arch cnvlutin --batch_size 1 --im_index_last 40 --dataset ../../Imagenet_dataset --weights ../2_copy_weight/vgg16_imagenet_fc_one_out.pkl

# For adversarial dataset
# python3 vgg16_power_delay.py --power --arch cnvlutin --batch_size 1 --im_index_last 40 --adversarial --adv_images ../5_detection/adversarial_data/adv_constrained.pt --weights ../2_copy_weight/vgg16_imagenet_fc_one_out.pkl
