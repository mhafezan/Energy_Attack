...
# For constrained:
# python3 vgg16_detect_clean.py --dataset ../../Imagenet_dataset --profile_sparsity_range ../4_profile/profile_data/sparsity_ranges.pt --profile_sparsity_map ../4_profile/profile_data/sparsity_maps.pt --sim_threshold 0.5

# For unconstrained:
# python3 vgg16_detect_clean.py --dataset ../../Imagenet_dataset --profile_sparsity_range ../4_profile/profile_data/sparsity_ranges.pt --profile_sparsity_map ../4_profile/profile_data/sparsity_maps.pt --sim_threshold 0.3