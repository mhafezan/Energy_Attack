...
class LeNet5(nn.Module):
    ...
    def forward(self, x, SR=True, PC=False):
        ...
        cycles_detail_inference = [a+b+c+d+e for a, b, c, d, e in zip(L1_cycles_detail, L2_cycles_detail, L3_cycles_detail, L4_cycles_detail, L5_cycles_detail)]
        
        eng_dnmc_detail_inference = [a+b+c+d+e for a, b, c, d, e in zip(L1_dnmc_detail, L2_dnmc_detail, L3_dnmc_detail, L4_dnmc_detail, L5_dnmc_detail)]
...
# python3 fmnist_power_delay.py --power --latency --arch cnvlutin --batch_size 10 --dataset ../fmnist_dataset --weights ../2_copy_weight/lenet5_fmnist_fc_one_out.pkl

# For testing adversarial dataset
# python3 fmnist_power_delay.py --power --latency --arch cnvlutin --batch_size 10 --adversarial --adv_images ../5_detection/adversarial_data/adversarial_dataset.pt --weights ../2_copy_weight/lenet5_fmnist_fc_one_out.pkl
