...
# python3 fmnist_power_delay.py --power --latency --arch cnvlutin --batch_size 1 --adversarial --adv_images ../5_detection/adversarial_data/adversarial_dataset.pt --weights ../2_copy_weight/lenet5_fmnist_fc_one_out.pkl
