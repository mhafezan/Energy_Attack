...
if __name__ == '__main__':
    ...
    parser.add_argument('--adv_datapath', default=None, help="The path to the adversarial images generated by energy attack algorithm")
    ...
    for index, (image, label) in enumerate(tqdm(test_loader, desc='Data Progress')):
        ...
        output = model(image, True, args.power) # (input image, activate SR calculation, activate power calculation)
