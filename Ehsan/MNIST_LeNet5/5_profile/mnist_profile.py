...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='../dataset/train', help="The path to the train datasets")
    ...
    # The profile function returns an array in which each element comprises a Sparsity-Map or Sparsity-Range Tensor assigned to each Class
    ...
    print(f"We should stop profiling at data-point {index+1} when profiling is based on {args.method}")
    print(f"P1 = {((index+1)/len(train_loader))*100} % of training-set has been used for profiling.")
...
# Arguments: python3 mnist_profile.py --method sparsity-map/range --dataset ../dataset/train --weights weights/lenet5_mnist_fc_one_out.pkl
