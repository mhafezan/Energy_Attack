...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='ImageNet Testing on ResNet18')
    ...
    parser.add_argument('--weights', default="/weights/resnet18-5c106cde.pth", help="The path to the weights")
    ...
    if args.pretrained:
        print("=> Using pre-trained weights to test ResNet18\n")
        model = resnet18(pretrained=True).to(device)
    else:
        print("=> Using a specified trained weights to test ResNet18\n")
    ...
    test_loader = torch.utils.data.DataLoader(test_sub_dataset, batch_size=args.batch_size, shuffle=False)
...
# python3 test.py --batch-size 1 --pretrained --im_index_last 50 --weights weights/resnet18-5c106cde.pth