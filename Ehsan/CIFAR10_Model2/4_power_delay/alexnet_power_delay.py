...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="AlexNet Network as BLACK-BOX model trained on CIFAR10 Dataset")
    parser.add_argument('--batch_size', default=1, type=int)
    parser.add_argument('--weights', default="../weights/alexnet_cifar10_fc_one_out.pkl", help="The path to the pretrained model")
...
#################### Arguments considering pretrained AlexNet as black-box model

# For test on adversarial CIFAR10
# python3 alexnet_power_delay.py --power --latency --arch cnvlutin --batch_size 1 --adversarial --adv_images adversarial_data/adversarial_dataset_by_substitute_model2.pt --weights weights/alexnet_cifar10_fc_one_out.pkl

# For test on original CIFAR10
# python3 alexnet_power_delay.py --power --latency --arch cnvlutin --batch_size 1 --dataset ../cifar10_dataset --weights weights/alexnet_cifar10_fc_one_out.pkl