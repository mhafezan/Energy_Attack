...
# for constrained:
# python3 cifar100_detect.py --adv_dataset adversarial_data/adv_constrained.pt --profile_sparsity_range ../5_profile/profile_data/sparsity_ranges.pt --profile_sparsity_map ../5_profile/profile_data/sparsity_maps.pt --sim_threshold 0.5

# for unconstrained:
# python3 cifar100_detect.py --adv_dataset adversarial_data/adv_unconstrained.pt --profile_sparsity_range ../5_profile/profile_data/sparsity_ranges.pt --profile_sparsity_map ../5_profile/profile_data/sparsity_maps.pt --sim_threshold 0.3